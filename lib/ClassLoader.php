...
class UniversalClassLoader
{
        ...
        public function registerSuffixes(array $suffixes)
        {
        ...
        public function findFile($class)
        {
                        ...
                        foreach ($this->namespaces as $ns => $dirs) {
                                ...
                                foreach ($dirs as $dir) {
                                        foreach($this->suffixes as $suffix) {
                                                $file = $dir.DIRECTORY_SEPARATOR.$normalizedClass.$suffix;
                                                if (is_file($file)) {
                                                        return $file;
                                                }
                                        }
                ...
                if ($this->useIncludePath) {
                        foreach($this->suffixes as $suffix) {
                                if($file = stream_resolve_include_path($normalizedClass.$suffix)) {
                                        return $file;
                                }
                        }
                }
